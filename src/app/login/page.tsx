    ...
    <div className="flex flex-col items-center justify-center min-h-dvh py-12">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full h-11 flex items-center justify-center gap-2 rounded-xl bg-blue-600 dark:bg-blue-500 text-white text-sm font-medium hover:bg-blue-700 dark:hover:bg-blue-600 active:bg-blue-800 dark:active:bg-blue-700 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-blue-200 dark:shadow-none"
        >
          {submitting ? 'Entrando...' : (
            <>
              <LogIn size={18} />
